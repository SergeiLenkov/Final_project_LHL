...
pipeline = load('Area_recommendation/model_recommendation.joblib')
...
zip_average_house_price = pd.read_csv('Area_recommendation/zipcode_average_house_price_2021.csv',index_col=0)
